...
#ifdef __GNUC__
    // GCC-specific workaround for missing __has_include
    @include "lv_conf.h"
    @ifndef LV_CONF_H
    #error "lv_conf.h could not be included."
    @endif
#else
    // For other compilers that don't support __has_include, you may have to manually verify inclusion or use similar tricks.
    #include "lv_conf.h"
	#ifndef LV_CONF_INCLUDE_SIMPLE
		#define LV_CONF_INCLUDE_SIMPLE
	#endif
